function Footer() {
  return (
    <footer 
      className="bg-no-repeat bg-cover bg-center w-screen"
      style={{
        backgroundImage:`url(${process.env.PUBLIC_URL+ "/img/color-smoke-abstract-wallpaper-aesthetic-background-design1.jpg"})`
      }}
    >
