...
function Register() {
    ...
    const handleSubmit = async () => {
        try {
            const res = await axios.post(`${process.env.REACT_APP_SERVER_URL}/api/v1/user/register`, {username, email, password}, { withCredentials: true });
            if (res.data.done) {
            ...
            <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                ...
                <div>
                    <div className="flex -mx-3">
                        <div className="w-full px-3 mb-5">
                            ...
                            <div className="flex">
                                ...
                                <input type="text" value={username} onChange={handleUsernameChange} className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="johnsmith" />
                            </div>
                        </div>
                    </div>
                    <div className="flex -mx-3">
                        <div className="w-full px-3 mb-5">
                            ...
                            <div className="flex">
                                ...
                                <input type="email" value={email} onChange={handleEmailChange} className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="johnsmith@example.com" />
                            </div>
                        </div>
                    </div>
                    <div className="flex -mx-3">
                        <div className="w-full px-3 mb-12">
                            ...
                            <div className="flex">
                                ...
                                <input type="password" value={password} onChange={handlePasswordChange} className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************" />
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col -mx-3">
                        ...
                        <div className="flex items-center space-y-2 justify-between w-full px-3 mb-5">
                            <p>Already have an account?</p>
                            <Link to="/login" className="text-center block w-1/4 max-w-xs mx-auto hover:bg-gray-200 focus:bg-gray-200 text-black rounded-lg px-3 py-3 font-semibold border border-black transition duration-100">Log in</Link>
                        </div>
